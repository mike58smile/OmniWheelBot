...
enum class SerialMode { Idle, Comm, Speed, RealSpeed, Kp1, Ki1, Kd1, CalibDeadBand, Meas1, Meas2, Size }; ///< Enum for selected serial mode state machine, "Size" is a little trick - contains number of elements in this enum
