...
\DoxyCodeLine{109      \textcolor{keyword}{struct }\mbox{\hyperlink{struct_state_class_1_1_meas}{Meas}} \{}
\DoxyCodeLine{110          \mbox{\hyperlink{_state_8h_a1a7dcd795684bd7e6ae6768721747aaf}{State\_measType}} \mbox{\hyperlink{struct_state_class_1_1_meas_af98b6703a5a62cd7459eddd9fed3877e}{state\_measType}};}
\DoxyCodeLine{111          \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} \mbox{\hyperlink{struct_state_class_1_1_meas_a1eac1ac7feda1471bbe85a2edceadf13}{motSelect}} = 0;}
\DoxyCodeLine{112          \textcolor{keywordtype}{int} \mbox{\hyperlink{struct_state_class_1_1_meas_a36cddf1b969111c010899836492d1f1e}{temp}} = 0;}
\DoxyCodeLine{113      \} \mbox{\hyperlink{class_state_class_af71942d5a7ee612dfa4ca7883392dd83}{meas}};}
\DoxyCodeLine{114 }
\DoxyCodeLine{115      \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} \mbox{\hyperlink{class_state_class_abfef7b427ef851b42ca9b508481a7cd1}{readSpeed}} = 0; }
\DoxyCodeLine{116      \textcolor{keywordtype}{int} \mbox{\hyperlink{class_state_class_ab9af462c4008bd3fb2442b2042d47331}{tempMode}};}
\DoxyCodeLine{117 \};}
\DoxyCodeLine{118 }
\DoxyCodeLine{119 \textcolor{keyword}{extern} \mbox{\hyperlink{class_state_class}{StateClass}} \mbox{\hyperlink{_state_8h_aa0cc817b371dc08979042179019be7da}{State}};}
\DoxyCodeLine{120 }
\DoxyCodeLine{121 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{122 }
\DoxyCodeLine{123 }
\DoxyCodeLine{135 \textcolor{comment}{/* Garbage:}}
\DoxyCodeLine{136 \textcolor{comment}{* }}
\DoxyCodeLine{137 \textcolor{comment}{* //\#define USE\_TIMER\_2 true //Use before TimerInterrupt library included -\/ defines which timer to use for interrupts (but it isn't working with Encoders)}}
\DoxyCodeLine{138 \textcolor{comment}{* }}
\DoxyCodeLine{139 \textcolor{comment}{* inline static const char* printState\_measType() \{}}
\DoxyCodeLine{140 \textcolor{comment}{    return stateArr\_measType[static\_cast<int>(State.meas.state\_measType)];}}
\DoxyCodeLine{141 \textcolor{comment}{\}}}
\DoxyCodeLine{142 \textcolor{comment}{inline static const char* printState\_actual() \{}}
\DoxyCodeLine{143 \textcolor{comment}{ return stateArr\_actual[static\_cast<int>(State.state\_actual)];}}
\DoxyCodeLine{144 \textcolor{comment}{\}}}
\DoxyCodeLine{145 \textcolor{comment}{inline static const char* printState\_comm() \{}}
\DoxyCodeLine{146 \textcolor{comment}{ return stateArr\_comm[static\_cast<int>(State.State.state\_comm)];}}
\DoxyCodeLine{147 \textcolor{comment}{\}}}
\DoxyCodeLine{148 \textcolor{comment}{* }}
\DoxyCodeLine{149 \textcolor{comment}{Initialization of static const array in .h file}}
\DoxyCodeLine{150 \textcolor{comment}{     static const uint8\_t Enc1Pin(size\_t index) \{}}
\DoxyCodeLine{151 \textcolor{comment}{         static const uint8\_t x[] = \{ 1,2 \};}}
\DoxyCodeLine{152 \textcolor{comment}{         return x[index];}}
\DoxyCodeLine{153 \textcolor{comment}{     \}}}
\DoxyCodeLine{154 \textcolor{comment}{*/}}
\DoxyCodeLine{155 }
\DoxyCodeLine{156 \textcolor{comment}{/* RPM Debounce}}
\DoxyCodeLine{157 \textcolor{comment}{ Relative to RPM readout and triggering to start  a thread path:}}
\DoxyCodeLine{158 \textcolor{comment}{}}
\DoxyCodeLine{159 \textcolor{comment}{  Index debounce will affect the sensitivity of the index signal. IT basically is how many interrupt periods the signal must be present, or not present before a change is actually sensed in that line. SO if set to 2 for example, when the index appears it will be ignored for 2 periods to make sure it isnt noise. Same with when it disappears. Setting debounce too high will make the index go away altogether.}}
\DoxyCodeLine{160 \textcolor{comment}{}}
\DoxyCodeLine{161 \textcolor{comment}{  Since the length of the index is dependent on spindle speed, minimum length is variable, but the time must be at least 1 period at a debounce of zero. SO in 25000, thats 40us.}}
\DoxyCodeLine{162 \textcolor{comment}{  If a person notices a dropoff in RPM at a certain speed, they need usually a lower index debounce. Index inputs from an encoder are usually pretty short and will limit speed readings at some point as you go higher.}}
\DoxyCodeLine{163 \textcolor{comment}{}}
\DoxyCodeLine{164 \textcolor{comment}{If you have the debounce setting too high the axis will just sit there waiting to confirm the rpm}}
\DoxyCodeLine{165 \textcolor{comment}{before the start of a thread path.}}
\DoxyCodeLine{166 \textcolor{comment}{}}
\DoxyCodeLine{167 \textcolor{comment}{Don't have specifics relative to switches .}}
\DoxyCodeLine{168 \textcolor{comment}{ */}}
\DoxyCodeLine{169 }
\DoxyCodeLine{170 \textcolor{comment}{//READ spd with millis}}
\DoxyCodeLine{171 \textcolor{comment}{//     unsigned long currentMillis\_1 = 0;}}
\DoxyCodeLine{172 \textcolor{comment}{//     unsigned long previousMillis\_1 = 0;}}
\DoxyCodeLine{173 \textcolor{comment}{// }}
\DoxyCodeLine{174  \textcolor{comment}{//    currentMillis\_1 = millis();}}
\DoxyCodeLine{175  \textcolor{comment}{//    if ((currentMillis\_1 -\/ previousMillis\_1) >= 200) \{}}
\DoxyCodeLine{176  \textcolor{comment}{//        encSpeed[0] = abs(Drive.enc1.read());}}
\DoxyCodeLine{177  \textcolor{comment}{//        Drive.enc1.write(0);}}
\DoxyCodeLine{178  \textcolor{comment}{//        encSpeed[1] = abs(Drive.enc2.read());}}
\DoxyCodeLine{179  \textcolor{comment}{//        Drive.enc2.write(0);}}
\DoxyCodeLine{180  \textcolor{comment}{//;       previousMillis\_1 = currentMillis\_1;}}
\DoxyCodeLine{181  \textcolor{comment}{//    \}}}
\DoxyCodeLine{182 }
\DoxyCodeLine{183 }
\DoxyCodeLine{184 \textcolor{comment}{// Using timer interrupt}}
\DoxyCodeLine{185 \textcolor{comment}{// INCLUDES}}
\DoxyCodeLine{186 \textcolor{comment}{// \#include <ISR\_Timer.h>}}
\DoxyCodeLine{187 \textcolor{comment}{//\#include <TimerInterrupt.hpp>}}
\DoxyCodeLine{188 \textcolor{comment}{//\#include <TimerInterrupt.h>}}
\DoxyCodeLine{189 \textcolor{comment}{//\#include <ISR\_Timer.hpp> }}
\DoxyCodeLine{190 }
\DoxyCodeLine{191 \textcolor{comment}{//SETUP:}}
\DoxyCodeLine{192 \textcolor{comment}{// Timer init}}
\DoxyCodeLine{193 \textcolor{comment}{//ITimer2.init();}}
\DoxyCodeLine{194 \textcolor{comment}{//if (ITimer2.attachInterruptInterval(TimerSpeedDelayMS, TimerSpeedHandler))}}
\DoxyCodeLine{195 \textcolor{comment}{//\{}}
\DoxyCodeLine{196 \textcolor{comment}{//    Serial.println(F("{}Starting  ITimer1 OK, millis() = "{})); Serial.println(millis());}}
\DoxyCodeLine{197 \textcolor{comment}{//\}}}
\DoxyCodeLine{198 \textcolor{comment}{//else}}
\DoxyCodeLine{199 \textcolor{comment}{//    Serial.println(F("{}Can't set ITimer1. Select another freq. or timer"{}));}}
\DoxyCodeLine{200 }
\DoxyCodeLine{201 \textcolor{comment}{//GLOBAL in .ino}}
\DoxyCodeLine{202 \textcolor{comment}{//Global variables}}
\DoxyCodeLine{203 \textcolor{comment}{//static volatile bool flagReadSpeed = 0; ///< Will be set true in interrupt routine}}
\DoxyCodeLine{204 \textcolor{comment}{//static volatile int interruptNum = 0; ///< Will increment in interrupt routine}}
\DoxyCodeLine{205 \textcolor{comment}{//void TimerSpeedHandler()}}
\DoxyCodeLine{206 \textcolor{comment}{//\{}}
\DoxyCodeLine{207 \textcolor{comment}{//    flagReadSpeed = 1;}}
\DoxyCodeLine{208 \textcolor{comment}{//    ++interruptNum;}}
\DoxyCodeLine{209 \textcolor{comment}{//\}}}
\DoxyCodeLine{210 }
\DoxyCodeLine{211 \textcolor{comment}{//In void loop:}}
\DoxyCodeLine{212 \textcolor{comment}{//if (flagReadSpeed) \{}}
\DoxyCodeLine{213 \textcolor{comment}{//    Drive.read();}}
\DoxyCodeLine{214 \textcolor{comment}{//    flagReadSpeed = 0;}}
\DoxyCodeLine{215 \textcolor{comment}{//    interruptNum = 0;}}
\DoxyCodeLine{216 \textcolor{comment}{//\}}}
\DoxyCodeLine{217 }
\DoxyCodeLine{218 \textcolor{comment}{//In Drive.read:}}
\DoxyCodeLine{219 \textcolor{comment}{//State.encSpeed[0] = abs(enc1.read());}}
\DoxyCodeLine{220 \textcolor{comment}{//enc1.write(0);}}
\DoxyCodeLine{221 \textcolor{comment}{//State.encSpeed[1] = abs(enc2.read());}}
\DoxyCodeLine{222 \textcolor{comment}{//enc2.write(0);}}
\DoxyCodeLine{223 }
\DoxyCodeLine{224 \textcolor{comment}{//In Comm::RequestEvent:}}
\DoxyCodeLine{225 \textcolor{comment}{//char strBuffer[7];}}
\DoxyCodeLine{226 \textcolor{comment}{//Wire.write(dtostrf(State.actualRealSpeed[0], 7, 2, strBuffer)); //!odskusat ci funguje}}
\DoxyCodeLine{227 \textcolor{comment}{//Wire.write(dtostrf(State.actualRealSpeed[1], 7, 2, strBuffer));//!odskusat ci funguje  }}
\DoxyCodeLine{228 }
\DoxyCodeLine{229 \textcolor{comment}{//RAMP:}}
\DoxyCodeLine{230 \textcolor{comment}{//bool ramp(int motor, int beginPWM = 0, float slope = 1);}}
\DoxyCodeLine{231 }
\DoxyCodeLine{232 \textcolor{comment}{//Motors Speed:}}
\DoxyCodeLine{234 \textcolor{comment}{}\textcolor{comment}{//if (Spd1 <= 0) \{}}
\DoxyCodeLine{235 \textcolor{comment}{//    analogWrite(State.M1\_LPWM, 0);}}
\DoxyCodeLine{236 \textcolor{comment}{//    analogWrite(State.M1\_RPWM, abs(Spd1));}}
\DoxyCodeLine{237 \textcolor{comment}{//\}}}
\DoxyCodeLine{238 \textcolor{comment}{//else\{}}
\DoxyCodeLine{239 \textcolor{comment}{//    analogWrite(State.M1\_RPWM, 0);}}
\DoxyCodeLine{240 \textcolor{comment}{//    analogWrite(State.M1\_LPWM, abs(Spd1));}}
\DoxyCodeLine{241 \textcolor{comment}{//\}}}
\DoxyCodeLine{242 }
\DoxyCodeLine{244 \textcolor{comment}{//if (Spd2 <= 0) \{}}
\DoxyCodeLine{245 \textcolor{comment}{//    analogWrite(State.M2\_LPWM, 0);}}
\DoxyCodeLine{246 \textcolor{comment}{//    analogWrite(State.M2\_RPWM, abs(Spd2));}}
\DoxyCodeLine{247 \textcolor{comment}{//\}}}
\DoxyCodeLine{248 \textcolor{comment}{//else \{}}
\DoxyCodeLine{249 \textcolor{comment}{//    analogWrite(State.M2\_RPWM, 0);}}
\DoxyCodeLine{250 \textcolor{comment}{//    analogWrite(State.M2\_LPWM, abs(Spd2));}}
\DoxyCodeLine{251 \textcolor{comment}{//\}}}
\DoxyCodeLine{252 \textcolor{comment}{//}}
\DoxyCodeLine{254 \textcolor{comment}{}\textcolor{comment}{//State.actualSpeed[0] = Spd1;}}
\DoxyCodeLine{255 \textcolor{comment}{//State.actualSpeed[1] = Spd2;}}
